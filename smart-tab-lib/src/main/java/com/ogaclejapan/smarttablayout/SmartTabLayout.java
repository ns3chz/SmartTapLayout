...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (viewPager != null && viewPager.getAdapter() != null) {
            internalViewPagerListener = new InternalViewPagerListener();
     ...
     * @return
     */
    public InternalViewPagerListener getInternalViewPagerListener() {
        return internalViewPagerListener;
    }
